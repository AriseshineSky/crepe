...
function inventoryCheckRecord(asin, type, quantity, producingStatus, inventorySheet) {
  getPm(asin, 'US').then(async function(pm) {
    var content = `${pm}\t${asin}\t${type}\t${quantity.quantity}\t${producingStatus.orderDues['airExpress']}\t${producingStatus.orderDues['airDelivery']}\t${producingStatus.orderDues['seaExpress']}\t${producingStatus.orderDues['sea']}\t${massage[type]}\n`;
